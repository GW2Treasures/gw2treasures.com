...
import { UnlocksRecipeIdColumn } from './page.client';
    ...
    <PageLayout>
      <ItemTableContext id="missingRecipes">
        ...
        <ItemTable
          ...
          extraColumns={[extraColumn<'item'>({ id: 'missing', select: { unlocksRecipeIds: true }, title: 'Missing Recipe IDs', component: UnlocksRecipeIdColumn as TODO, componentProps: { missingIds }})]}
          defaultColumns={['missing', 'item']}/>
      </ItemTableContext>
    </PageLayout>
  );
}
