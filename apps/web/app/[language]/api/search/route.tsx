...
import { searchAchievements, searchBuilds, searchCurrencies, searchItems, searchSkills, searchSkins, searchTraits, splitSearchTerms } from './helper';
...
export async function GET(request: Request) {
  ...
  const [achievements, currencies, items, skills, traits, skins, builds] = await Promise.all([
  ...
  return NextResponse.json({ searchValue, terms, ...achievements, currencies, items, skills, traits, skins, builds });
}
