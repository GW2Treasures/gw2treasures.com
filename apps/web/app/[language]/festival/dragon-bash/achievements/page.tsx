  ...
  return (
    <PageLayout>
      ...
      <AchievementTable achievements={achievements} language={language}>
        {(table, ColumnSelect) => (
          <>
            <Description actions={ColumnSelect}><Trans id="festival.dragon-bash.achievements.description"/></Description>
            {table}
          </>
        )}
      </AchievementTable>
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    description: t('festival.dragon-bash.achievements.description'),
    alternates: getAlternateUrls('festival/dragon-bash/achievements', language),
  };
}
