...
export default async function FourWindsWizardsVaultPage({ params }: PageProps) {
  ...
  return (
    <PageLayout>
      ...
      <p><Trans id="festival.four-winds.wizards-vault.description"/></p>
      ...
      {objectives.length > 0 ? objectives.map((objective) => (
        ...
        <Notice>No Wizard&apos;s Vault objectives for the Festival of the Four Winds are available in the Guild Wars 2 API yet.</Notice>
      )}
