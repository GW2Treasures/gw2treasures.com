...
export const contentSecurityPolicyMiddleware: NextMiddleware = async (request, next, data) => {
  ...
  const cspHeader = `
    ...
    img-src 'self' icons-gw2.darthmaim-cdn.com render.guildwars2.com wiki.guildwars2.com tiles1.gw2.io data:;
    ...
    report-uri https://gw2treasures.report-uri.com/r/d/csp/enforce;
    report-to default;
  `.replace(/\s{2,}/g, ' ');
