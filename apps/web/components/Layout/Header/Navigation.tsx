  ...
  return (
    <HorizontalOverflowContainer>
      <ul className={styles.navigation}>
        ...
        <li className={styles.item}><LinkButton appearance="menu" href="/wizards-vault" icon="wizards-vault"><Trans id="navigation.wizardsVault"/><span className={styles.new}>new</span></LinkButton></li>
