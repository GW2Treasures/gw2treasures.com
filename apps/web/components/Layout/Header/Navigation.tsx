  ...
  return (
    <HorizontalOverflowContainer>
      <ul className={styles.navigation}>
        ...
        <li className={styles.item}><LinkButton appearance="menu" href="/homestead" icon="homestead"><Trans language={language} id="navigation.homestead"/><span className={styles.new}>new</span></LinkButton></li>
