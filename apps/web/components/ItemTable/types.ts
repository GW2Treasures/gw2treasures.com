...
export type GlobalColumnId = 'id' | 'item' | 'icon' | 'name_de' | 'name_en' | 'name_es' | 'name_fr' | 'level' | 'rarity' | 'type' | 'weight' | 'vendorValue' | 'buyPrice' | 'buyPriceTrend' | 'buyQuantity' | 'sellPrice' | 'sellPriceTrend' | 'sellQuantity';
