  ...
  return (
    <PageLayout>
      ...
      <SnowDiamondConversions.Table initialSortBy="price">
        ...
        <SnowDiamondConversions.Column id="trend" title="Price Trend (7d)" small>{({ item, type }) => <PriceTrend history={item.tpHistory} price={`${type}Price`}/>}</SnowDiamondConversions.Column>
