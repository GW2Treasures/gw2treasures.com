...
export default async function EventPage({ params }: PageProps) {
  ...
  return (
    <HeroLayout color="#dacaa1" hero={<Headline id="birthday">Evon Gnashblade’s “Birthday” celebration</Headline>}>
      ...
      <p>Head to the <b>Black Lion &quot;Birthday&quot; Manager</b> at The Vaults in Lion&apos;s Arch to exchange materials for items. Each purchase has a total per account limit during the event.</p>
